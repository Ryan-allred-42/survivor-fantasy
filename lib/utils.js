...
export const SCORING_METHOD_LABEL = "Full Season";

export const SCORING_METHOD_DESCRIPTION =
  "Every episode, points you put on surviving players are multiplied by the boot order of whoever just got voted out — early boots earn little, but the top 5 are worth a fortune.";
